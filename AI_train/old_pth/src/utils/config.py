...
class DataGenerationConfig:
    ...
    include_mixed_scenarios: bool = True
    include_boundary_samples: bool = True
    include_conflict_samples: bool = True
    boundary_sample_ratio: float = 0.15
    conflict_sample_ratio: float = 0.15
    dynamic_uncertainty: bool = True
    max_uncertainty: float = 0.9
...
class DataConfig:
    ...
    data_dir: str = "data"
    raw_data_dir: str = "/home/featurize/data/raw"
    processed_data_dir: str = "data/processed"
    models_dir: str = "/home/featurize/output/models"
    checkpoint_dir: str = "/home/featurize/outputcheckpoints"
...
class Config:
    ...
    def from_dict(self, config_dict: Dict[str, Any]):
        ...
        # Data configuration - handle nested data_generation
        data_settings = config_dict.get("data", {})
        data_generation_settings = data_settings.pop("data_generation", {})
        self.data = DataConfig(**data_settings)
        
        # Update data generation configuration if provided
        if data_generation_settings:
            self.data.data_generation = DataGenerationConfig(**data_generation_settings)
